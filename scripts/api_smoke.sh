...
check "cdrs csv"                   200 "${AUTH[@]}" "$BASE/api/v1/cdrs?format=csv&limit=5"
check "alerts"                     200 "${AUTH[@]}" "$BASE/api/v1/alerts"
check "config"                     200 "${AUTH[@]}" "$BASE/api/v1/config"
check "tls certificates"           200 "${AUTH[@]}" "$BASE/api/v1/tls/certificates"
